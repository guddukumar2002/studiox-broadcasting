...
import { FileText, Clock, CheckCircle, XCircle, Plus, ArrowRight, Radio, TrendingUp } from "lucide-react";
import { useRouter } from "next/navigation";
import Link from "next/link";

function StatCard({ label, value, icon: Icon, bg, color, loading, hint }) {
    ...
    <DashboardLayout>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-5 gap-4">
        ...
        <div className="lg:col-span-3 flex flex-col gap-4">
          ...
          {/* Live banner */}
          <div className="relative rounded-xl overflow-hidden bg-gradient-to-br from-blue-700 to-blue-500 p-6 text-white">
            {/* Decorative circles */}
            ...
            <div className="relative">
              ...
              <h2 className="text-[16px] font-bold mb-1.5">Live Room Ready</h2>
              <p className="text-[13px] text-blue-100 mb-5 leading-relaxed max-w-sm">
                Share your approved content with students in real-time. Your live page is always accessible.
              </p>
            ...
            <div className="p-2">
              {loading ? (
                ...
                <div className="text-center py-8 text-[13px] text-gray-400">
                  No uploads yet — <Link href="/teacher/upload" className="text-blue-600 font-medium hover:underline">upload your first content</Link>
                </div>
              )}
            </div>
          </div>
